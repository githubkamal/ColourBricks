...
{
    /// <inheritdoc />
    public partial class P3T03_AddAllocation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObligationId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Allocation_Obligation_ObligationId",
                        column: x => x.ObligationId,
                        principalTable: "Obligation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Allocation_Party_PartyId",
                        column: x => x.PartyId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Allocation_Settlement_SettlementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allocation_PartyId_ProjectId",
                table: "Allocation",
                columns: new[] { "PartyId", "ProjectId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allocation_SettlementId",
                table: "Allocation",
                column: "SettlementId");
        }
